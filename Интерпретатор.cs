...
class Интерпретатор
{
    ...
    public uint Вычислить(string исходник)
    {
        ...
        // Ищем первую лексему.
        // Во всей программе нужно следовать принципу: перед тем как передать
        // управление дальше, должна быть установлена еще не обработанная лексема.
        СледующаяЛексема();
